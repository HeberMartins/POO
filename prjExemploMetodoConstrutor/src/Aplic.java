...
public class Aplic {
	...
	//Passagem de mensagens
        ...
        do{
			...
			System.out.println("\n\nMedida da altura do retângulo: " + objRet.getAltura() + objRet.getUnidadeMed());
            System.out.println("Medida da base do retângulo: " + objRet.getBase() + objRet.getUnidadeMed());
            if (opcao == 1){
                System.out.println("Medida da área: " + objRet.calcArea() + objRet.getUnidadeMed() + "²");
            }else
               if (opcao == 2){
                   System.out.println("Medida do perímetro: " + objRet.calcPerimetro() + objRet.getUnidadeMed());       
               }else
                  if (opcao == 3){
                      System.out.println("Medida da diagonal: " + objRet.calcDiagonal() + objRet.getUnidadeMed());
                  } 
        }while(opcao < 4);        
    }        
}
